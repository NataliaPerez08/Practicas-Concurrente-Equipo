...
class Counter {
    ...
    private PetersonLockTree lockTree;

    Counter(PetersonLockTree lock) {
        this.valor = 0;
        this.lockTree = lock;
    }

    int obtenEIncrementa(){
        this.lockTree.tomaCandado();
        int res = this.valor;
        valor = this.valor + 1;
        this.lockTree.sueltaCandado();
        return res;
    }
